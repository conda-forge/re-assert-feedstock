...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/re-assert-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15040&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/re-assert-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `re-assert` can be installed with:

```
conda install re-assert
```

It is possible to list all of the versions of `re-assert` available on your platform with:
